...
static void get_canaries_positions(Stack* stack, Canary_data** left_canary, Canary_data** right_canary) { //in structure???
    *left_canary = (Canary_data*)stack->data;
    *right_canary = (Canary_data*)(stack->data + sizeof(Stack_data) * stack->capacity + sizeof(Canary_data));
}
